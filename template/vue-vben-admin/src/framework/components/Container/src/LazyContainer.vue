...
<script lang="ts">
  ...
  import { useTimeoutFn } from '/@/framework/hooks/core/useTimeout';
  import { useIntersectionObserver } from '/@/framework/hooks/event/useIntersectionObserver';
